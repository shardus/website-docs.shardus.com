...
<div className="mt-16 mb-20 text-center">
  [Get Started](/docs/installation/quickstart) · [Examples](/docs/examples/README) · [Website](https://shardus.com) · [GitLab](https://gitlab.com/shardus)
</div>
...
this is to jump right in and try it with the five minute [quickstartguide](/docs/installation/quickstart).
